...
/**
 * ErrorInfo class representing a single error/exception. Holds many useful
 * data.
 * 
 * @author Ferenc Kis
 * @version 1.1
...
public class ErrorInfo {
	...
	public String toString() {
		return getDevLogString();
	}

	/**
	 * Creates a detailed and formatted error message
	 * 
	...
	public String getDevLogString() {
		...
		if (!parameters.isEmpty()) {
			...
			for (String s : parameters.keySet()) {
				String v = (parameters.get(s) == null) ? "null" : parameters
						.get(s).toString();
